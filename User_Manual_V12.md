...
> 版本：v12　最後更新：2026-06-17
> 系統網址（本機測試）：http://127.0.0.1:5501
> Netlify：https://glistening-crostata-4189e7.netlify.app
> 本版新增（v11-v12）：teacher.html 學期下拉+資訊卡/列切換+教師欄、admin.html 帳號管理（4級權限）+大綱完成度+學生列表12欄+學生資料列表Excel+班級名條Excel+課程點名單列印、student.html gauge ①②③④修正+畢業論文頁gauge、公佈欄全部收合（3個檔案）、RLS全面修復（syllabi/enrollments/students等12個表）
...
| 檔案 | 對象 | 登入 | 版本 | 說明 |
|------|------|------|------|------|
| `admin.html` | 行政 | 是 | v4.5 | 後台管理（含帳號管理、列印功能）|
...
| # | 項目 | 說明 | 依賴 |
|---|------|------|------|
| 11 | admin 橫向滾動 | min-width:0 修了但用戶測試仍無滾動條 | admin.html CSS |
| 12 | topbar fixed/sticky | 嘗試多次都導致內容被遮蔽，已回退 | CSS |
...
*系統版本：admin v4.5 / student v2.2 / teacher v2.2　最後更新：2026-06-17*
